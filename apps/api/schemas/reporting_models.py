"""Reporting response and entry schemas."""
...
__all__ = [
    ...
    "TotalReportRead",
    "TotalReportResponse",
    "NetWorthChangeWindow",
    "RunRateSummary",
    "CashRunwaySummary",
    "CategoryTotalEntry",
    "TotalOverviewKpis",
    "TotalYearEntry",
    "YearCategoryMixEntry",
    "SourceChangeEntry",
    "SourceTotalEntry",
    "TotalAccountOverviewEntry",
    "InvestmentSeriesPoint",
    "InvestmentYearEntry",
    "InvestmentAccountValueEntry",
    "TotalInvestmentsOverview",
    "TotalDebtAccountEntry",
    "TotalDebtOverview",
    "MonthlyIncomeExpensePoint",
    "CategoryYearHeatmapRow",
    "CategoryYearHeatmap",
    ...
    "YearlyOverviewMonthEntry",
    "NetWorthSeriesPoint",
    "DebtSeriesPoint",
    "SavingsIndicator",
    "BiggestMonthEntry",
    "YearlyOverviewStats",
    "YearlyCategoryBreakdownEntry",
    "MerchantSummaryEntry",
    "LargestTransactionEntry",
    "CategoryChangeEntry",
    "InvestmentAccountSummaryEntry",
    "InvestmentsSummary",
    "DebtOverviewEntry",
    "AccountFlowEntry",
    "SourceSummaryEntry",
